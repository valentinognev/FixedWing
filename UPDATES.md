...
- Live GZ 120 s `race_quat` `pn` `/tmp/balloon_race_race_quat_gz_baseline.csv`: first circuit B0 **3.73** (XY 0.69, ΔD −3.66, t=47.3) / B1 **0.57** (XY 0.07, ΔD −0.57, t=63.9) / B2 **3.61** (XY 1.78, ΔD −3.14, t=77.5) m. Gate ≤5 m passed.
